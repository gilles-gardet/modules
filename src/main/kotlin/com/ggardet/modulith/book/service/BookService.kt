...
import com.ggardet.modulith.book.api.BookCreateRequest
import com.ggardet.modulith.book.api.BookDeleted
import com.ggardet.modulith.book.api.BookUpdateRequest
...
class BookService(
    ...
    fun handleAuthorDeleted(event: AuthorDeleted) {
        ...
        if (deletedCount > 0) {
            logger.info("Deleted {} book(s) associated with author {} (ID: {})", deletedCount, event.name, event.authorId)
        }
    }
}
