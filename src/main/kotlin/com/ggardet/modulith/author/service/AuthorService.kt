...
import com.ggardet.modulith.author.api.AuthorCreateRequest
import com.ggardet.modulith.author.api.AuthorCreated
import com.ggardet.modulith.author.api.AuthorDeleted
import com.ggardet.modulith.author.api.AuthorUpdateRequest
...
class AuthorService(
    ...
    fun createAuthor(request: AuthorCreateRequest): Author {
        ...
        eventPublisher.publishEvent(AuthorCreated(savedAuthor.id, "$savedAuthor.firstName $savedAuthor.lastName"))
        return savedAuthor
    }
    ...
    fun updateAuthor(id: Long, request: AuthorUpdateRequest): Author {
        ...
        eventPublisher.publishEvent(AuthorUpdated(savedAuthor.id, "$savedAuthor.firstName $savedAuthor.lastName"))
        return savedAuthor
    }
